...
\item Consider again the ODE $\frac{\mathrm dy}{\mathrm dt} = f(y) = (y-1)^2 (y-2) (y-3)$ from the previous question. If $y(t)$ is a solution and $y(0.5)=2.8$, what is $\lim_{t\to\infty} y(t)$? Justify your choice.
\end{enumerate}
\end{minipage}\hfill
...
\includegraphics[width=0.5\linewidth]{field3}
\includegraphics[width=0.5\linewidth]{field4}\\
...
\includegraphics[width=0.5\linewidth]{field5}
\includegraphics[width=0.5\linewidth]{field6}\\
